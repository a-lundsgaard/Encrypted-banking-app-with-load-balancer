...
const Client = require("./banking_application/database/models/client");
const Account = require("./banking_application/database/models/account");
const fetch = require("node-fetch");
const chai = require("chai");
const should = chai.should();
const config = require("./banking_application/app.js");
